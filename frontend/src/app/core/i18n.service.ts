...
const translations: Record<Locale, Record<string, string>> = {
  lv: {
    ...
    gameTitle: 'Spēles nosaukums', description: 'Apraksts', language: 'Valoda', timeLimit: 'Laiks', addCategory: 'Pievienot sadaļu',
    ...
    deleteSessionConfirm: 'Dzēst iesākto spēli “{title}”?', deleteSessionError: 'Iesākto spēli neizdevās izdzēst.',
  ...
  en: {
    ...
    gameTitle: 'Game title', description: 'Description', language: 'Language', timeLimit: 'Time', addCategory: 'Add category',
    ...
    deleteSessionConfirm: 'Delete started game “{title}”?', deleteSessionError: 'Could not delete the started game.',
