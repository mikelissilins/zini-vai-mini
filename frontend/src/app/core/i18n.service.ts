...
const translations: Record<Locale, Record<string, string>> = {
  lv: {
    ...
    startBuilding: 'Sākt veidot spēli', openDashboard: 'Atvērt spēļu paneli',
    ...
    explanation: 'Papildu skaidrojums', freeText: 'Brīvā atbilde', multipleChoice: 'Atbilžu varianti',
  ...
  en: {
    ...
    startBuilding: 'Build a game', openDashboard: 'Open dashboard',
    ...
    explanation: 'Extra explanation', freeText: 'Free answer', multipleChoice: 'Multiple choice',
